            ...
            <div className="page-width max-sm:px-3">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-3 lg:gap-6">
                    ...
                    <div className="group aspect-square rounded-xl relative overflow-hidden">
                        ...
                        <div className="flex items-center justify-between gap-8 p-8 bg-brand-dark-2/80 backdrop-blur-xl absolute bottom-0">
                            <div className="space-y-2">
                                <h3 className="text-xl font-semibold text-background">Dynamic Load Balancing</h3>
                                <p className="text-sm text-background/60">Automatically distribute power across your EV fleet to optimize charging efficiency and prevent grid overload.</p>
                            </div>
                    ...
                    <div className="col-span-full rounded-xl p-6 bg-white">
                        <h3>Smart Scheduling</h3>
                        <p>Schedule charging sessions during off-peak hours to reduce electricity costs and minimize grid impact.</p>
                    </div>
