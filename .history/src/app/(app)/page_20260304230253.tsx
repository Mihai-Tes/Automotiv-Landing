      ...
      <section className="h-screen bg-neutral-900 text-white pt-16">
        <div className="page-width grid grid-cols-6 h-full">
          <div className="col-span-2 flex flex-col justify-center space-y-6">
            ...
            <p className="text-sm text-muted-foregroundt mb-12">Increase savings, automate busy work, and make better decisions by managing global HR, Payroll, IT, and Finance in one place.</p>
