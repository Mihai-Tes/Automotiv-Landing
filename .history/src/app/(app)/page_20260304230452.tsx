      ...
      <section className="h-screen bg-neutral-900 text-white pt-16">
        <div className="page-width grid sm:grid-cols-1 lg:grid-cols-6 h-full">
          <div className="col-span-2 flex flex-col justify-center space-y-6">
            ...
            <h1 className="text-6xl font-bold tracking-tigh">The All-in-One solution for auto repair shops</h1>
            <p className="text-md text-muted-foregroundt mb-12">Increase savings, automate busy work, and make better decisions by managing global HR, Payroll, IT, and Finance in one place.</p>
