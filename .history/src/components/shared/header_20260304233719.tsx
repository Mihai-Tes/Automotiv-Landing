...
export default function Header() {
    ...
    return (
        <header className="h-16 fixed top-0 left-0 right-0 z-50 text-white">
            ...
            <div className={cn("absolute left-0 right-0 top-0 h-0 bg-[#242429]/90 backdrop-blur-md opacity-0 transition-all duration-300 ease-in-out", scroll && "h-full opacity-100")}></div>
        </header>
    );
}