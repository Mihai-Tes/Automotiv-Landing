...
export default function Header() {
    ...
    return (
        <header className="h-16 fixed top-0 left-0 right-0 z-50 text-white">
            <div className="page-width h-full flex items-center gap-12 z-10">
            ...
            <div className={cn("absolute left-0 right-0 top-0 h-0 bg-[#242429]/90 backdrop-blur-md transition-height duration-300 ease-in-out", scroll && "h-full")}></div>
        </header>
    );
}